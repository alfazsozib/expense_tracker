...
<div className="w-[1125px] h-full bg-white rounded-[20px] flex flex-col items-start px-10 pt-10">
  ...
  <div className="mb-12 w-full">
    ...
    <div className="flex items-center space-x-4">
      ...
      <button className=" mt-9 py-2 px-4 bg-[#90E0EF] rounded text-black text-xl font-medium">
        Add Expense
      </button>
    </div>
  </div>
