  ...
  return (
    <div>
      <div className="flex ">
        ...
        <div className="w-[720px] h-[1024px] px[137px] pt-[150px] flex flex-col justify-center items-center bg-white p-10">
          <h1 className="text-4xl font-freehand mb-10">Welcome</h1>

          <div className="w-full max-w-md">
            <div className="flex gap-4 mb-4">
              <div className="flex flex-col w-1/2">
                <label className="text-[20px] font-normal text-[#000] mb-1">First Name</label>
                <input
                  type="text"
                  name="f_Name"
              ...
              <div className="flex flex-col w-1/2">
                <label className="text-[20px] font-normal text-[#000] mb-1">Last Name</label>
                <input
                  type="text"
                  name="l_Name"
                  className="px-4 py-2 rounded-md bg-[#d9d9d966] outline-none h-[50px]"
